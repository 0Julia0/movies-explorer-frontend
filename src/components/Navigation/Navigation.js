...
function Navigation(props) {
    ...
    return (
        <div className='header__navigation'>
            <div className={props.loggedIn ? 'header__navigation-login_invisible' : 'header__navigation-login'}>
            ...
            <div className={props.loggedIn ? 'header__navigation-movies' : 'header__navigation-movies_invisible'}>
            ...
            <button className={props.loggedIn ? 'header__menu-button' : 'header__menu-button_invisible'} onClick={handleOpenMenuButtonClick}></button>
